...
% TODO:
%
% Nell'esempio, e nelle conclusioni, parlare di determinismo e motivare. [MATTEO]
% Tagliare almeno mezza pagina (magari \small nella bibliografia) 
% Sistemare intro [VINCENZO]
% Motivare meglio UP-determinacy con apprendimento. [VINCENZO]
% Mettere footnote con spiegazione per submission simultanea: permessa a MEMO (!) [MATTEO]
% Citare Victor?
% Rispondere a critica Victor
...
\section{Nominal regular \texorpdfstring{$\omega$}{omega}-languages}\label{sec:languages}\input{languages}
