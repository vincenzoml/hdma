...
For each nDMA, there is an \hdma{} accepting the same language, whose set of states is in one to one correspondence to the orbits of the original automaton.
\end{proposition}
